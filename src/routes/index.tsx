...
const projects = [
  ...
  },
  {
    ...
    details: [
      "Contexto",
      "Um tribunal de justiça estadual utilizava um sistema de gestão de processos administrativos digitais em ambiente de alta complexidade regulatória, com regras de sigilo, hierarquia de setores e múltiplos perfis de usuário. Advogados e servidores enfrentavam dificuldade para localizar processos e gestores operavam sem visibilidade analítica das operações.",
      "Problema",
      "A busca principal era lenta e imprecisa. Sem dashboards, decisões sobre volume de processos, tramitações e produtividade eram tomadas sem dados, um gap crítico para uma instituição de grande porte.",
      "O que fiz",
      "Conduzi o discovery com stakeholders, mapeei o funcionamento atual e identifiquei as oportunidades. A partir das validações com o cliente, liderei duas frentes:",
      "Na busca: redesenhei a lógica principal, defini novos filtros obrigatórios e coordenei a atualização da busca textual, viabilizando consultas mais precisas e rápidas.",
      "Nos dashboards: especifiquei 5 painéis gerenciais em Power BI cobrindo quantidade de processos por setor, histórico de movimentações, tempo de vida, histórico de tarefas e controle de perfis de acesso. Toda a solução respeitou regras de sigilo e hierarquia de setores.",
      "Resultado",
      "Pela primeira vez, gestores passaram a ter visibilidade analítica sobre os processos digitais, com filtros hierárquicos, gráficos por assunto e período, e acesso direto ao sistema a partir dos painéis. A busca mais eficiente reduziu a fricção no dia a dia de advogados e servidores.",
    ],
  },
];
